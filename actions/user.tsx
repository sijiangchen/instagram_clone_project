...
export const signup=()=>{
    return async(dispatch,getState) =>{
        ...
        if(response.user.uid){
            ...
            alert('User has beend signed up!')
        }
    }
    catch(e){   
        alert(e)
...
export const login = () =>{
    return async(dispatch,getState) =>{
        try{
            ...
            dispatch(getUser(response.user.uid)) //retrieve the unique id of the user
        }catch(e){
            alert(e)
        }
    }
...
//therefore in the function below we get statistics and data from the user with the given unique id
